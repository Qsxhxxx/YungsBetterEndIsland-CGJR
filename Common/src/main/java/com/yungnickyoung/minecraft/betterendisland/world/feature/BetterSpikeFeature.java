...
public class BetterSpikeFeature {
    ...
    private static int getSpikeLowestSurfaceY(ServerLevelAccessor level, int x, int z, int radius) {
        ...
        return minY != Integer.MAX_VALUE ? minY : (BetterEndIslandCommon.betterEnd ? 70 : 60);
    }
}
